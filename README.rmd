...
`r emo::ji("calendar")` March, 2021
<br>
`r emo::ji("clock")` approx. 3h (in company) and 5h (for MSc students in class)
<br>
...
You can access the lecture sheets 9 (in html) via [pricing-analytics-sheets](https://katrienantonio.github.io/PE-pricing-analytics/sheets/pricing_analytics_with_GAMs_and_GLMs_IABE.html) and in pdf via [pricing-analytics-sheets-pdf](https://katrienantonio.github.io/PE-pricing-analytics/sheets/pricing_analytics_lecture_sheets_in_pdf.pdf). 
