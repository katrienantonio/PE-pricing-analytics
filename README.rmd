...
Course materials for the *Pricing analytics in R* course in March 2020 in Leuven and Brussels.

`r emo::ji("calendar")` March, 2020
<br>
`r emo::ji("clock")` approx. 3h
<br>
`r emo::ji("location")` IA|BE in Brussels, Data science for non-life insurance class at KU Leuven


## Goals of the workshop

You'll work through the essential steps of the implementation in `R` of the pricing framework proposed in the [paper](https://www.tandfonline.com/doi/abs/10.1080/03461238.2018.1429300) "A data driven binning strategy for the construction
...
You can access the lecture sheets via [pricing-analytics-sheets](https://katrienantonio.github.io/PE-pricing-analytics/sheets/pricing_analytics_with_GAMs_and_GLMs_IABE.html). These are under construction and will be updated!
...
We provide a back-up plan in case your local installation of R (and the necessary packages) is not working properly. Please join our project on RStudio Cloud via the following link
